...
# OUTPUT FILE PATH
FCT_OUTPUT_FILE ./examples/my-rdma-test/outputs/fct.txt
PFC_OUTPUT_FILE ./examples/my-rdma-test/outputs/pfc.txt

# MONITOR SETTINGS
QLEN_MON_FILE ./examples/my-rdma-test/outputs/qlen.txt
BW_MON_FILE ./examples/my-rdma-test/outputs/bw.txt
RATE_MON_FILE ./examples/my-rdma-test/outputs/rate.txt
CNP_MON_FILE ./examples/my-rdma-test/outputs/cnp.txt
MON_START 2000001
MON_END 5000000
QP_MON_INTERVAL 100
...
ENABLE_TRACE 0
TRACE_FILE ./examples/my-rdma-test/trace_config.txt
TRACE_OUTPUT_FILE ./examples/my-rdma-test/outputs/mix.tr
