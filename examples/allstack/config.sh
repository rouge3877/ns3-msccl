...
BW_MON_FILE ./examples/allstack/outputs/bw.txt
RATE_MON_FILE ./examples/allstack/outputs/rate.txt
CNP_MON_FILE ./examples/allstack/outputs/cnp.txt
MON_START 2000001
MON_END 5000000
QP_MON_INTERVAL 100
...
ENABLE_TRACE 0
TRACE_FILE ./examples/allstack/trace_config.txt
